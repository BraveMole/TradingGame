...
public class ScrollPaneIndustrie extends WidgetGroup{
        ...
        public ScrollPaneIndustrie (Actor widget, com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle style) {
            ...
            addCaptureListener(new InputListener() {
                ...
                public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                    ...
                    if (getStage() != null) getStage().setScrollFocus(ScrollPaneIndustrie.this);

                    if (!flickScroll) setScrollbarsVisible(false);
